...
class ChatController extends Controller
{
    public function send(Request $request)
    {
        ...
        $system = <<<SYS
            ...
            - Если спрашивают про вакансии: зови инструмент get_vacancies (фильтр по тексту и/или типу) и дай короткий список + ссылку на страницу вакансий.
            - Если спрашивают про конкретную вакансию: зови get_vacancy_details (id или название) и дай краткое описание + ссылку для отклика.

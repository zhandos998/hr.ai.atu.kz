        ...
        $response = OpenAI::chat()->create([
            ...
            'messages' => [
                [
                    ...
                    2.1) Если в разделе требований к квалификации НЕТ указаний на образование
                    (например: не требуется диплом, нет слов 'образование', 'degree', 'университет'),
                    то устанавливай education_match = 5 даже при отсутствии документов.
